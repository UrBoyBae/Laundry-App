...
@section('mainContent')
    <div class="my-addTransaction">
        ...
        <div class="my-addTransaction-form">
            <div class="my-left-form">
                <div class="my-form-modal" style="margin: 0">
                    <input type="hidden" name="id_transaksi" id="id_transaksi" value="{{ $id_transaksi }}" autocomplete="off"
                        required>
                    ...
                    <div class="my-input-modal">
                        <input type="date" name="tanggalTransaksi" id="tanggal" placeholder="Masukkan No.Tlp"
                            autocomplete="off" required>
                    </div>
                    <label class="my-label-input">Batas Waktu/Tenggat</label>
                    <div class="my-input-modal">
                        <input type="date" name="bataswaktu" id="tenggat" placeholder="Masukkan No.Tlp"
                            autocomplete="off" required>
                    </div>
                </div>
            </div>
            <div class="my-right-form">
                <div class="my-form-modal" style="margin: 0">
                    ...
                    <div class="my-input-modal">
                        <input type="text" name="pajak" id="pajak" placeholder="Masukkan Pajak" autocomplete="off"
                            required>
                    </div>
        ...
        <div class="my-modal-btn">
            ...
            <button type="submit" class="my-addBtn-modal-add" id="editTransaction">Submit</button>
        </div>
    </div>
@endsection
